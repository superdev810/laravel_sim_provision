            ...
            <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">User Address</span>
                    </div>
                </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="btn-group">
                                    <a href="{{route('download-address','1')}}"  class="btn sbold green"> Download Sample file
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
        ...
        (function (global) {
            var dataTable = $('#domain-email-table').DataTable({
                ...
                "pageLength": 50,
                ajax: '{!! route('contact-file-list') !!}',
                columns: [
                    {data: 'file_name', name: 'file_name', "orderable": true, "searchable":true,"width": "40%"},
                    {data: 'total_contact', name: 'total_contact', "orderable": false, "searchable":false},
