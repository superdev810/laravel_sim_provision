                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Sim Information List Of file <span
                                    style="color:#002D57 !important;"> <strong>{{$file->file_name}}</strong></span></span>
                    </div>
                </div>
    ...
    $(function () {
        ...
        (function (global) {
            ...
            var dataTable = $('#domain-email-table').DataTable({
                ...
                ajax: '{!! route('sim-file-list',['file_id' =>$file->id]) !!}',
                columns: [
                    ...
                    {
                        data: 'existing_new_subscribe',
                        name: 'existing_new_subscribe',
                        "orderable": true,
                        "searchable": true
                    },
