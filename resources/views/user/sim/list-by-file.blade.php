            ...
            <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Sim Information List Of file <span
                                    style="color:#002D57 !important;"> <strong>{{!empty($file->file_name) ? $file->file_name : '' }}</strong></span></span>
                    </div>
                </div>
    ...
    $(function () {
        ...
        (function (global) {
            ...
            var dataTable = $('#domain-email-table').DataTable({
                ...
                ajax: '{!! route('sim-file-details-list',['file_id' =>$file->id]) !!}',
                columns: [
                    ...
                    {data: 'message', name: 'message', "orderable": true, "searchable":true,"width": '20%'},
